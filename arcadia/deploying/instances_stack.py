...
class Instances(NestedStack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Windows
        windows_bootstrapping = ec2.UserData.for_linux()
        ...
        windows_bootstrapping.add_commands(
            f"",
        )
                ...
                "enable_ssh": ec2.InitConfig(
                    [
                        ec2.InitCommand.shell_command(
                            shell_command="Get-WindowsCapability -Online | Where-Object Name -like ‘OpenSSH.Server*’ | Add-WindowsCapability –Online",
                            # cwd=working_dir,
                        ),
                    ]
                ),
        ...
        instance = ec2.Instance(
            ...
            init_options=ec2.ApplyCloudFormationInitOptions(
                ...
                config_sets=["connectivity", "services"],
