...
class ImageBuilderWindowsPipeline(NestedStack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        component_os = imagebuilder.CfnComponent(
            self,
        ...
        component_steam = imagebuilder.CfnComponent(
            self,
            "component_steam",
            name="InstallSteam",
            platform="Windows",
        ...
        component_game = imagebuilder.CfnComponent(
            self,
            "component_game",
            name="InstallGame",
            platform="Windows",
        ...
        base_image_arn = (
            f"arn:aws:imagebuilder:{self.region}:aws:image/ubuntu-server-20-lts-x86/2023.9.7",
        )
        base_image_arn = (
            "ami-0092a751c04951b01"  # TODO hard-code override. af-south-1 region
        )
        ...
        recipe.apply_removal_policy(removal_policy)
