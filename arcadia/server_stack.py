...
from arcadia.deploying.security.server_authorization_nestedstack import (
    ServerAuthorization,
)
...
class Server(Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #     name='*rs2*', owners=[str(self.account)],
        #     filters={'architecture': ['x86_64']},
        #     windows=True,
        # )
        machine_image = ec2.MachineImage.generic_windows(
            {"af-south-1": "ami-02352c1bd2cd9aea3"}
        )  # TODO hardcoding
